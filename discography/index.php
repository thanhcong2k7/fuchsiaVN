                    ...
                    <tbody>
                      ...
                      if ($release == null)
                        ...
                        foreach ($release as &$r) {
                          ...
                          echo '
                          <tr>
                            <td><img loading="eager" style="border-radius:5px; border-style:solid; border-color:white; border-width:2px;" src="' . (!isset($r->artp) || ($r->artp == "") ? '/assets/images/alb.png' : $r->artp) . '" class="product-img" alt="product img"></td>
                            <td>' . ($r->upc ? $r->upc : "--") . '</td>

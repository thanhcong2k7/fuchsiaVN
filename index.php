  ...
  <ul class="navbar-nav align-items-center right-nav-link">
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
        <span class="user-profile"><img src="assets/images/gallery/ava_sample.png" class="img-circle" alt="user avatar"></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="assets/images/gallery/ava_sample.png" alt="user avatar"></div>
        ...
        <div class="row row-group m-0">
                ...
                <div class="card-body">
                  <h5 class="text-white mb-0">It is <span id="codepro-hour"></span>
					<span class="float-right"><i class="fa fa-delicious"></i></span></h5>
...
<?php
	...
	foreach ($release as &$rel)
		if ($rel->status==0)
			$draftcnt++;
?>
                  <h5 class="text-white mb-0">Drafts: <?php echo $draftcnt; ?><span class="float-right"><i class="zmdi zmdi-album"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:100%"></div>
                    </div>
                  <p class="mb-0 text-white small-font">Total Releases <span class="float-right"><?php echo $cnt; ?></span></p>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0">13,535,702 VND <span class="float-right"><i class="fa fa-usd"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:100%"></div>
                    </div>
                  <p class="mb-0 text-white small-font">Your Balance <span class="float-right">+112% <i class="zmdi zmdi-long-arrow-up"></i></span></p>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">Total Stream <span class="float-right">+5.2% <i class="zmdi zmdi-long-arrow-up"></i></span></p>
                </div>
            </div>
        </div>
    </div>
	...
	<div class="row">
     <div class="col-12 col-lg-8 col-xl-8">
	    <div class="card">
		 <div class="card-header">Stream Statistics
     ...
     <div class="col-12 col-lg-4 col-xl-4">
        <div class="card">
           <div class="card-header">Monthly Revenue
             <div class="card-action">
             <div class="dropdown">
             <a href="javascript:void();" class="dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown">
              <i class="icon-options"></i>
	...
	<div class="row">
	 <div class="col-12 col-lg-12">
	   <div class="card">
	     <div class="card-header">Recent releases
		  <div class="card-action">
             	<div class="dropdown">
			<a href="discography/" class="text dropdown-toggle dropdown-toggle-nocaret">
			  <i class="zmdi zmdi-album"></i> Go to Discography
			</a>
		 </div>
	       <div class="table-responsive">

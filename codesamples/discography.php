                                ...
                                <table class="table align-items-center mb-0">
									...
									<?php
										...
										for($i=0; $i<$a; $i++){
											...
											//echo "<script>alert('".$tmp_arr."');</script>";
											if ($tmp_arr!=NULL)
											...
											echo "<script>console.log('".($albumname[$i]==NULL?"--":$albumname[$i])."');</script>";
											echo '<tr>
													<td>
														<div class="d-flex px-2 py-1">
															<div>
																<img src="'.$lnk.'" class="avatar avatar-sm me-3" alt="'.($albumname[$i]==NULL?"--":$albumname[$i]).' Artwork">
															</div>
															<div class="d-flex flex-column justify-content-center">
																<h6 class="mb-0 text-sm">'.($albumname[$i]==NULL?"--":$albumname[$i]).'</h6>
																<p class="text-xs text-secondary mb-0">'.$artist[$i].'</p>
															</div>
														</div>
													</td>
													<td>
														<p class="text-xs font-weight-bold mb-0">'.($upc[$i]==NULL?"--":$upc[$i]).'</p>
													</td>
													<td class="align-middle text-center">
														<span class="text-secondary text-xs font-weight-bold">'.($reldate[$i]!=NULL?date("d/m/Y",DateTime::createFromFormat('Y-m-d', $reldate[$i])->getTimestamp()):"--").'</span>
													</td>

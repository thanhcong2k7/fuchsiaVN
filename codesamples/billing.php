            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/">Lunaris</a></li>
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Dashboard</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Billing details</h6>
                </nav>
                    ...
                    <div class="card p-3 mb-4">
                        <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url(https://demos.creative-tim.com/soft-ui-dashboard/assets/img/ivancik.jpg);">
                            ...
                            <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                                <h5 class="text-white font-weight-bolder mb-4 pt-2">Name Banking <?php echo $tnh;?> <?php echo "test"; ?></h5>
                                <p class="text-white">STK: <?php echo $stk; ?></p>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column h-100">
                                        <p class="mb-1 pt-2 text-bold">Unpaid amount</p>
                                        <h5 class="font-weight-bolder"></h5>
                                        <p class="mb-5"><?php echo $cash; ?> left until paid</p>
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                                <canvas id="chart-bars" class="chart-canvas chartjs-render-monitor" height="168" style="display: block; height: 168px; width: 495px; box-sizing: border-box;" width="495"></canvas>

                            </div>
                            <h6 class="ms-2 mt-4 mb-0">Streams on all platforms</h6>
                            <p class="text-sm ms-2"> (<span class="font-weight-bolder info">+23%</span>) than last week </p>
                                ...
                                <div class="row">
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Spotify</p>
                                        </div>
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">YouTube</p>
                                        </div>
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Apple Music</p>
                                        </div>
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Others</p>
                                        </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <p class="text-sm">
                                ...
                                <span class="font-weight-bold">300% more</span> in 2024
                            </p>
                        </div>

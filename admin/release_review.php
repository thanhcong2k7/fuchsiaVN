                        ...
                        <?php else: ?>
                            <?php foreach ($unclaimedReleases as $release): ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" onclick="claimRelease(<?php echo $release->id; ?>)">Claim</button>
                                        <a href="view_release.php?id=<?php echo $release->id; ?>" class="btn btn-info btn-sm">View</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
